...
class recharge {
    ...
    private $appkey='a30d45fd4d3491fc0e510aa7644082ac';
    
//    private $appkeyyk='42dec63e5d4889f6ce79d65286f3d256';
 
    private $openid='JH510576c2415aa84fcacdbef5461d80d6';
    ...
    private $submitUrlyk = 'http://op.juhe.cn/ofpay/sinopec/onlineorder';
     private $submitUrllpk = 'http://v.juhe.cn/giftCard/buy';
 ...
 public function ykcz($proid,$cardnum,$orderid,$game_userid,$gasCardTel,$gasCardName,$chargeType){
...
//$content = juhecurl($url,$paramstring);
        $content = $this->juhecurl($this->submitUrlyk,$paramstring);
         return $this->_returnArray($content);
    }
    
    
    public function lpkcz($num,$productId,$orderid){
...
//        return $paramstring;
//$content = juhecurl($url,$paramstring);
        $content = $this->juhecurl($this->submitUrllpk,$paramstring);
         return $this->_returnArray($content);
    }
    /**
     * 查询订单的充值状态
